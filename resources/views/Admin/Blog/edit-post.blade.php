    ...
    <div class="content">
        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-heading">
                <h2 class="panel-title text-center" style="border-bottom: 1px solid #DDDDDD; margin-bottom: 10px; margin-right: 10px"> Edit Post </h2>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel-body">
                        {!! Form::model($data,['url' => '/admin/'.$data['id'].'/edit-post/update', 'class' =>'form-horizontal','files' => true]) !!}
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            @if($errors->has('category'))
                                                                ...
                                                                @endforeach
                                                            @else
                                                                {{ Form::checkbox('category[]',$id, null,['class' => 'field']) }} {{ $name }}
                                                            @endif
                                                        </label>
                                                    </div>
                                                </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-1">Current Thumbail : </label>
                            <div class="col-md-11">
                                <img src="{{asset('News-Content/News/'.$data->thumbail)}}" alt="{{ $data->title }} Image" width="100" height="100" />
                            </div>
                        </div>
                        <div class="form-group">
